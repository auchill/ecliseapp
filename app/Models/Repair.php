...
class Repair extends Model
{
    ...
    public const STATUS_LABELS = [
        'booking_created' => 'Repair created',
    ...
    {
        return $this->hasMany(RepairStatusUpdate::class, 'repair_id')->latest();
    }

    public function publicStatusUpdates(): HasMany
    {
        return $this->hasMany(RepairStatusUpdate::class, 'repair_id')
    ...
    {
        return $this->hasOne(RepairShipping::class, 'repair_id');
    }
