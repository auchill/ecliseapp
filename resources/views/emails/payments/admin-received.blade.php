...
<html>
    <body style="font-family: Arial, sans-serif; color: #111827; line-height: 1.5;">
        ...
        <table cellpadding="8" cellspacing="0" style="border-collapse: collapse; width: 100%; max-width: 640px;">
            <tr><td><strong>Customer</strong></td><td>{{ $payment->payable->customer?->full_name ?? 'Customer unavailable' }}</td></tr>
            <tr><td><strong>Email</strong></td><td>{{ $payment->payable->customer?->email ?? 'Unavailable' }}</td></tr>
