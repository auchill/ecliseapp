...
@section('content')
    <section class="page-header">
        <div class="container">
            ...
            <h1 class="display-5 fw-bold mb-3">Continue with your tracking number.</h1>
            <p class="fs-5 mb-0">After your quote is approved, enter the repair tracking number Eclise sent to your email.</p>
        </div>
    </section>
            ...
            <div class="row g-4 align-items-start">
                <div class="col-lg-7">
                    <form class="surface p-4 p-lg-5" method="POST" action="{{ route('repairs.store') }}">
                        ...
                        <div class="input-group input-group-lg">
                            <input class="form-control" id="tracking_number" name="tracking_number" value="{{ old('tracking_number') }}" placeholder="ECL-REP-2026-0001" required>
                ...
                <div class="col-lg-5">
                    <div class="surface p-4">
                        ...
                        <p class="muted">Start with a quote request. Eclise will review the issue and contact you before creating the repair booking.</p>
